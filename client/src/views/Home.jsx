	...
	return (
		<div className='Home'>
			...
			<div className="row">
				...
				<img id="top3-pic" src="https://i.imgur.com/97VfGl6.png" alt="pic1"/>
				</div>
			</div>
			<div className="row">
				<div className="column">
				<h5 >See potential candidates that have the same interests!</h5>
				<img id="step2-pic" src="https://i.imgur.com/Ig9C0ZB.png" alt="pic2"/>
				</div>
				<div className="column column-50 column-offset-25">
				...
				<div className="row">
					...
					<img id="top3-pic" src="https://i.imgur.com/k2WJFEE.png" alt="pic3"/>
					</div>
				</div>
