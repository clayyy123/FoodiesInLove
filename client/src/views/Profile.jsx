...
class Profile extends React.Component {
    ...
    httpClient.datUser(this.props.current._id).then(serverResponse => {
      ...
      this.setState({
        fields: {
          ...
          bio: bio,
          topThree: [],
          topThree1: topThree[0],
          topThree2: topThree[1],
          topThree3: topThree[2],
          imageUrl: [],
          pic1: imageUrl[0],
          pic2: imageUrl[1],
          pic3: imageUrl[2],
  ...
  handleSubmit(evt) {
    ...
    this.setState({
      fields: {
        ...this.state.fields,
        [this.state.fields.topThree]: this.state.fields.topThree.push(
          this.state.fields.topThree1,
          this.state.fields.topThree2,
          this.state.fields.topThree3
        ),
        [this.state.fields.imageUrl]: this.state.fields.imageUrl.push(
          this.state.fields.pic1,
          this.state.fields.pic2,
          this.state.fields.pic3
        )
      }
    });
    ...
    return (
      <div className="Profile">
        ...
        >
          ...
          />
          <label for="nameField">
            Top Three Restaurants You Want To Eat At
          </label>{' '}
          <a
